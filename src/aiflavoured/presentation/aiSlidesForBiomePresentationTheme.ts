...
export const aiSlidesForBiomePresentationTheme = async (model : string = 'gpt-4o', numOfSlides : string = '10', docsData : string, audience : string, wording : string, userPrompt : string) :Promise<string> => {
