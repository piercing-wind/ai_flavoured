...
export const uploadAudioToS3 = async (fileName : string, fileType : string, fileSize : number, userId: string) : Promise<{awsS3 : {url : string, data : DataAudio}}> => {
   try {
     ...
     const data : DataAudio = { fileKey, fileName, fileType, url : downloadUrl, id: uuidv4()};
